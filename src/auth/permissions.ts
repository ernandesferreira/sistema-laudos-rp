...
export const PERMISSION_CATALOG = [
  ...
  {
    key: "licenses.view",
    name: "Visualizar licencas liberadas",
    resource: "licenses",
    description: "Listar e consultar licencas liberadas automaticamente apos aprovacao final.",
  },
  {
    key: "licenses.revoke",
    name: "Revogar licencas liberadas",
    resource: "licenses",
    description: "Revogar licencas e aplicar bloqueio por prazo ou definitivo para documentos.",
  },
  {
    key: "discord.manage",
    name: "Gerenciar notificacoes Discord",
    resource: "discord",
    description: "Cadastrar webhooks, configurar eventos e acompanhar logs de notificacoes no Discord.",
  },
  {
